...
<html>
	<body>
		<h2> <a style="color:black" href="current_classes_small.php">Current Classes</a>
		...
		<a class="btn btn-danger" href="assets/dropslip.docx"
				onclick="return confirm('Some classes could not be dropped online, do you want to generate a drop slip?')">
